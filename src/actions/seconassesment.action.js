import {SELECT_COMPETENCIES,SELECT_QUESTIONS, ALL_GROUPS,
  ALL_COMPETENCY,
  ALL_QUESTIONS,
  EDIT_MODE} from './actionTypes';
import {uniqueId,get} from 'lodash';
import {endAjaxCall, beginAjaxCall} from './ajaxstatus.action';
import {getResource, postResource,getAllAssessment} from './assestments.action'; 
...
export const setEditMode= val=>{return {type:EDIT_MODE,val}}
...
export const confirm= (questions,assesmentId) => dispatch=>{
    dispatch(beginAjaxCall())
    postResource(`${url}/secondary/confirm`,{id:assesmentId,questioner:questions}).then(res => {
